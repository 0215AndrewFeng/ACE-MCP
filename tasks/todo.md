...
- 2026-07-21: macOS release handoff completed independently of the pending Windows artifact. Created Gitee Release `v4.10.1` (#755360), uploaded `ace-mcp-4.10.1.tgz` (#2940488, 397666 bytes), verified the public download SHA-256 `15e459224c036bfc3fc4d1f2db0cc523493e8d43089bb0148b6f7c901e4449c8`, and confirmed the tag-fixed installer defaults to 4.10.1. A fully isolated installer run downloaded the public tgz, installed 152 packages, returned `ace-mcp --version` 4.10.1, and reported doctor 8 ok, 2 expected warnings, 0 errors. The Windows x64 ZIP remains explicitly pending.
